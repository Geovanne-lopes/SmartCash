    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            localStorage.setItem(
                "userSession",
                JSON.stringify({ user: { id: data.id, nome: data.nome, email: data.email } })
            );
        ...
        border border-indigo-400/10 p-10 rounded-3xl shadow-[0_0_60px_rgba(99,102,241,0.2)] ml-[8vw]"
            >
                <div className="text-center mb-6">
                    ...
                    <h1 className="text-4xl font-extrabold bg-gradient-to-r from-indigo-400 via-violet-400 to-blue-400 
